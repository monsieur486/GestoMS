 ...
 * {@link com.mr486.generator.pipeline.ZipTemplateLoader}. Le drapeau {@code executable} préserve le
 * bit d'exécution Unix des entrées du ZIP modèle (utile pour {@code mvnw}, {@code *.sh}).
 *
 * @param path       chemin relatif dans le ZIP (ex: {@code "ms-platform/pom.xml"})
