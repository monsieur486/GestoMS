package com.mr486.msplatform.webui.config;
...
public record WebUiProperties(List<ResourceEntry> resources, String keycloakAccountUrl) {

    /**
     * Entrée du catalogue décrivant un service CRUD exposé par l'UI.
     *
