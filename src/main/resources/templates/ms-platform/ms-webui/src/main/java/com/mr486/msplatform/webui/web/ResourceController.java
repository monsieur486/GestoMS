...
import com.mr486.msplatform.webui.security.ResourceAccess;
...
public class ResourceController {
    ...
    public ResourceController(GatewayClient gatewayClient, WebUiProperties webUiProperties) {
    ...
    public String index(Authentication authentication, Model model) {
        model.addAttribute("resources",
                ResourceAccess.accessible(webUiProperties.resources(), authentication.getAuthorities()));
        return "resources";
    }
    ...
    public String list(@PathVariable String serviceName, Authentication authentication,
        ...
        ResourceEntry entry = ResourceAccess.find(
                webUiProperties.resources(), authentication.getAuthorities(), serviceName);
        if (entry == null) {
